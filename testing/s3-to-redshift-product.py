...
selectfields_4 = SelectFields.apply(frame = applyMapping_3, paths = ["product", "product_id", "unit_price", "category", "stock_code","dim_category","category"], transformation_ctx = "selectfields_4")
## @type: ResolveChoice
## @args: [choice = "MATCH_CATALOG", database = "glue_db", table_name = "redshift_db_sales_stg_products", transformation_ctx = "resolvechoice3"]
## @return: resolvechoice3
## @inputs: [frame = selectfields2]
...
datasink_7=glueContext.write_dynamic_frame.from_jdbc_conf(frame = selectfields_4 ,catalog_connection = "redshift", connection_options = { "preactions":"truncate table sales.tgt_dim_products;", "dbtable": "sales.tgt_dim_products", "database": "redshift_db"},redshift_tmp_dir = args["TempDir"])
...
## @return: <output>
## @inputs: [frame = <frame>]
rename_02 = RenameField.apply(frame = selectFields_2, old_name = "categorysurrkey", new_name = "dim_category", transformation_ctx = "rename_02")
applyMapping_3 = ApplyMapping.apply(frame = rename_02, mappings = [
    ("product_id","int","product_id","int"),
    ("product","string","product","string"),
    ("unit_price","double","unit_price","double"),
    ("stock_code","string","stock_code","string"),
    ("category","int","category","int"),
    ("dim_category","int","dim_category","int"),
    ], transformation_ctx = "applyMapping_3")
